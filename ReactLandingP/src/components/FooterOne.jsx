                ...
                <div className="FooterSocials">
                    ...
                    <div className="FooterSocialsContainer">
                        <a href="https://www.linkedin.com/in/hafizau/">
                            <img className="SocialIcon2" src={linkedInBlackIcon} alt="LinkedIn" />
                        </a>
                        <a href="https://www.youtube.com/@Auvance">
                            <img className="SocialIcon2" src={youTubeBlackIcon} alt="LinkedIn" />
                        </a>
                        <a href="https://codepen.io/Auvancee">
                            <img className="SocialIcon2" src={codepenBlackIcon} alt="LinkedIn" />
                        </a>
                        <a href="https://github.com/Auvancee">
                            <img className="SocialIcon2" src={githubBlackIcon} alt="LinkedIn" />
                        </a>
                        <a href="https://github.com/Auvancee">
                            <img className="SocialIcon2" src={behanceBlackIcon} alt="LinkedIn" />
                        </a>
                    </div>
                </div>
